...
#include <Bounce.h>
 ...
 // assign the cabinet buttons using the Bounce library to a 10ms debounce
...
Bounce button7 = Bounce(16, 5);    // Coin                            (5)
 ...
 // Assign the cabinet shift function button 
...
void loop(){
  ...
  dataForController_t controllerData = getBlankDataForController();
   ...
   // Cabinet Joystick Button Section 
  ...
  shift_function = !digitalRead(14);
  
   // Cabinet Keyboard Button Routine 
  /*
  if (shift_function == LOW) {                    // Shift Function button is held down (LOW)
    
  button0.update();    // Alternate use Left Flipper Button
  ...
  button1.update();   // Alternate use Right Flipper Button
 ...
 button2.update();    //Alternate use Left Secondary Flipper Button
 ...
 button3.update();    //Alternate Use Right Secondary Flipper Button
  ...
  button4.update();    //Alternate use Start Button
  ...
  button5.update();   //Alternate use Exit Button
  ...
  button6.update();    //Alternate use Launch Ball Button  
 ...
 button7.update();    //Alternate use Coin Button 
 ...
 else {                 // Shift Function Button is released (HIGH)
*/
