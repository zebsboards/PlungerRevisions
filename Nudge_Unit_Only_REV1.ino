...
Bounce button0 = Bounce(4, 5);     // Left Flipper Button             (Left Arrow)
Bounce button1 = Bounce(5, 5);     // Right Flipper Button            (Right_Arrow)
Bounce button2 = Bounce(6, 5);     // Left Secondary Flipper button   (Left_CTRL)(Up Arrow) 
Bounce button3 = Bounce(7, 5);     // Right Secondary Flipper Button  (Right_CTRL) (Down Arrow)  
Bounce button4 = Bounce(8, 5);     // Start Button                    (1)
Bounce button5 = Bounce(9, 5);     // Exit Button                     (Esc)(C) 
...
void setup(){
  ...
  // delay to aid in getting past the computer POST/Windows startup
...
*/}
 ...
 /* button0.update();    //Read the state of the Left Flipper Button
   ...
   if (button0.fallingEdge())         // is the button pressed
    {
    Keyboard.press(0xD8);             //set the left arrow key
    }
   if (button0.risingEdge())          // is the button released 
    {
    Keyboard.release(0xD8);           // set the release command 
    }
