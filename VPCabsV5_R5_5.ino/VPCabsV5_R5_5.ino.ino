/*
  ...
  *************************************************************************************************************************************
  ...
  V4Rev5_4 October 2021 Revision
  ...
  - Added External Calibration Swich Input (when Expander is installed)
...
int Gamepadflag = 0;      // gamepad mode status flag  0 = OFF  1 = ON  start system in default ON (1) Gamepad setting
...
int tilt_button = 9;   // TILT Button assignment - assigned by position in keys array
...
//**************************************** Assign Keystroke Array *************************************************

                                                  // check and see if there are values in EEprom ('1' = YES, '0'or'255' = NO)
  ...
  Wire.setClock(3400000);            // set i2c frequency to 1700000hz
  delay(10);
