...
bool LIS2DH12::begin(uint8_t i2cAddress, TwoWire &wirePort)
{
  _i2cPort = &wirePort;
...
void LIS2DH12::setInt1Threshold(uint8_t threshold)
{
  lis2dh12_int1_gen_threshold_set(&dev_ctx, threshold);
}

uint8_t LIS2DH12::getInt1Threshold(void)
{
  uint8_t threshold;
...
void LIS2DH12::setInt1Duration(uint8_t duration)
{
  lis2dh12_int1_gen_duration_set(&dev_ctx, duration);
}
uint8_t LIS2DH12::getInt1Duration(void)
{
  uint8_t duration;
...
void LIS2DH12::setIntPolarity(uint8_t level)
{
...
void LIS2DH12::setInt1IA1(bool enable)
{
...
void LIS2DH12::setInt1Latch(bool enable)
{
...
void LIS2DH12::setInt1(bool enable)
{
